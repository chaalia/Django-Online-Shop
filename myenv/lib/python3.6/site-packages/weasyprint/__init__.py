...
class HTML(object):
    ...
    def render(
        ...
        return Document._render(
            self, stylesheets, enable_hinting, presentational_hints, font_config
        )
    ...
    def write_image_surface(
        ...
        """
        surface, _width, _height = self.render(
            stylesheets,
            enable_hinting=True,
            presentational_hints=presentational_hints,
            font_config=font_config,
    ...
    def write_png(
        ...
        """
        png_bytes, _width, _height = self.render(
            stylesheets,
            enable_hinting=True,
            presentational_hints=presentational_hints,
            font_config=font_config,
...
def _select_source(
    ...
    if len(selected_params) != 1:
        raise TypeError(
            "Expected exactly one source, got "
        ...
        sources_names = (
            ", ".join(
                name
                for name in ("guess", "filename", "url", "file_obj", "string")
