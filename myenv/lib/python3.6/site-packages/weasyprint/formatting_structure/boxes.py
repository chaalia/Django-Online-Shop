...
class Box(object):
    ...
    def __repr__(self):
        return "<{} {}>".format(type(self).__name__, self.element_tag)
    ...
    def is_in_normal_flow(self):
        ...
        return not (
            self.is_floated() or self.is_absolutely_positioned() or self.is_running()
        )
...
class PageBox(ParentBox):
    ...
    def __repr__(self):
        return "<{} {}>".format(type(self).__name__, self.page_type)
...
class MarginBox(BlockContainerBox):
    ...
    def __repr__(self):
        return "<{} {}>".format(type(self).__name__, self.at_keyword)
