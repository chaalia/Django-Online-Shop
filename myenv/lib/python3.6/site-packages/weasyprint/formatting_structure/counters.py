...
register_style("disc", type="repeating", symbols=["•"], suffix=" ")  # U+2022, BULLET
register_style(
    "circle", type="repeating", symbols=["◦"], suffix=" "  # U+25E6 WHITE BULLET
)
register_style(
    "square",
    type="repeating",
...
register_style("lower-latin", type="override", override="lower-alpha")
register_style("upper-latin", type="override", override="upper-alpha")
