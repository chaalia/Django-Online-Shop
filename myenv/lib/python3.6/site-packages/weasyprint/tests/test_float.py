...
def outer_area(box):
    ...
    return (box.position_x, box.position_y, box.margin_width(), box.margin_height())
...
def test_floats_3():
    ...
    body, = html.children
    positions = [
        (paragraph.position_x, paragraph.position_y) for paragraph in body.children
    ]
    assert positions == [
        (0, 0),
        (70, 0),
...
def test_floats_page_breaks_1():
    ...
    for page in pages:
        ...
        del images
    positions_y = [[img.position_y for img in images] for images in page_images]
...
def test_float_text_indent_1():
    ...
    assert span.width == span_text.width == ((1 + 5) * 20)  # text-indent + span text
