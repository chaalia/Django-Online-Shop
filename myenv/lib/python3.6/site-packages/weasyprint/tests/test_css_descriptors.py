...
def test_font_face_1():
    ...
    assert src == ("src", (("external", "http://example.com/fonts/Gentium.woff"),))
...
def test_font_face_2():
    ...
    assert src == (
        "src",
        (("external", "http://weasyprint.org/foo/Fonty-Smiley.woff"),),
    )
...
def test_font_face_3():
    stylesheet = tinycss2.parse_stylesheet(
        "@font-face {" "  font-family: Gentium Hard;" "  src: local();" "}"
    )
    at_rule, = stylesheet
    assert at_rule.at_keyword == "font-face"
    font_family, src = list(
...
def test_font_face_4():
    # See bug #487
    stylesheet = tinycss2.parse_stylesheet(
        "@font-face {" "  font-family: Gentium Hard;" "  src: local(Gentium Hard);" "}"
    )
    at_rule, = stylesheet
    assert at_rule.at_keyword == "font-face"
    font_family, src = list(
...
def test_font_face_bad_1():
    ...
    assert src == ("src", (("external", "http://weasyprint.org/foo/BadFont.woff"),))
