...
PROPER_CHILDREN = {
    ...
    for key, value in {
        ...
        boxes.TableBox: [
            [
                boxes.TableCaptionBox,
                boxes.TableColumnGroupBox,
                boxes.TableColumnBox,
    ...
    return [
        (
            ...
            (
                ...
                else serialize(getattr(box, "column_groups", ()) + tuple(box.children))
            ),
        )
        for box in box_list
    ]
...
def parse_all(html_content, base_url=BASE_URL):
    ...
    box = build.build_formatting_structure(*_parse_base(html_content, base_url))
    _sanity_checks(box)
    return box
...
def render_pages(html_content):
    ...
    return [
        p._page_box
        for p in FakeHTML(string=html_content, base_url=BASE_URL)
...
def _sanity_checks(box):
    ...
    assert any(
        all(
            isinstance(child, acceptable_types) or not child.is_in_normal_flow()
...
def test_html_entities():
    for quote in ['"', "&quot;", "&#x22;", "&#34;"]:
        assert_tree(
            parse("<p>{}abc{}".format(quote, quote)),
            [("p", "Block", [("p", "Text", '"abc"')])],
        )
                ...
                (
                    ...
                    [
                        (
                            ...
                            [
                                ("div", "Text", "Hello, "),
                                ("em", "Inline", [("em", "Text", "World")]),
                                ("div", "Text", "!\n"),
                            ],
                        )
                    ],
                ),
                ("p", "Block", [("p", "Line", [("p", "Text", "Lipsum.")])]),
            ],
        )
    ]
    box = parse(source)
        ...
        (
            ...
            [
                (
                    ...
                    [
                        ("p", "Text", "Hello "),
                        ("em", "Block", [("em", "Line", [("em", "Text", "World")])]),
                        ("p", "Text", "!"),
                    ],
                )
            ],
...
@pytest.mark.parametrize(
    "page_type, top, right, bottom, left",
    (
        (
            ...
            (
                ...
                [
                    (
                        ...
                        [
                            ("img", "InlineReplaced", "<replaced>"),
                            ("img", "Inline", [("img", "Text", "No src")]),
                            ("img", "Inline", [("img", "Text", "Inexistent src")]),
                        ],
                    )
                ],
            )
    ...
    assert_tree(
        ...
        [
            (
                "p",
                "Block",
                [("p", "Line", [("img", "Inline", [("img", "Text", "No base_url")])])],
            )
        ],
    )
            ...
            (
                ...
                [
                    (
                        "x-caption",
                        "TableCaption",
                        [("x-caption", "Line", [("x-caption", "Text", "top caption")])],
                    ),
                    (
                        "x-table",
                        "Table",
                        [
                            ...
                            (
                                "x-thead",
                                "TableRowGroup",
                                [("x-thead", "TableRow", [("x-th", "TableCell", [])])],
                            ),
                            (
                                "x-table",
                                "TableRowGroup",
            ...
            (
                ...
                [
                    (
                        ...
                        "Table",
                        [
                            ("span", "TableColumnGroup", [("em", "TableColumn", [])]),
                            ("ins", "TableColumnGroup", [("ins", "TableColumn", [])]),
                        ],
                    )
                ],
            )
...
def test_tables_4():
    # Rules 2.1 then 2.3
    assert_tree(
        parse_all("<x-table>foo <div></div></x-table>"),
        [
            (
                "x-table",
                "Block",
...
def test_tables_5():
    ...
    assert_tree(
        parse_all(
            '<x-thead style="display: table-header-group">'
...
def test_nested_grid_x():
    ...
    table, = wrapper.children
    grid = [
        (colgroup.grid_x, [col.grid_x for col in colgroup.children])
            ...
            (
                ...
                [
                    (
                        ...
                        "Line",
                        [
                            ("p::before", "Inline", [("p::before", "Text", "ab")]),
                            ("p", "Text", " c "),
                            ("p::after", "Inline", [("p::after", "Text", "de")]),
                        ],
                    )
                ],
            )
            ...
            (
                ...
                [
                    (
                        "p",
                        "Line",
                        [("p::before", "Inline", [("p::before", "Text", counter)])],
                    )
                ],
            )
            ...
            (
                ...
                [
                    (
                        "p",
                        "Line",
                        [("p::marker", "Inline", [("p::marker", "Text", "1. ")])],
                    )
                ],
            ),
        ],
            ...
            (
                ...
                [
                    (
                        "section",
                        "Block",
                        [("section", "Line", [("section::before", "Inline", [])])],
                    ),
                    (
                        "h1",
                        "Block",
            ...
            (
                ...
                [
                    (
                        "p",
                        "Line",
                        [("p::before", "Inline", [("p::before", "Text", "0")])],
                    )
                ],
            ),
        ],
            ...
            (
                ...
                [
                    (
                        "p",
                        "Line",
                        [("p::marker", "Inline", [("p::marker", "Text", "0. ")])],
                    )
                ],
            )
        ],
                    ...
                    (
                        ...
                        [
                            (
                                "p::marker",
                                "Block",
                                [("p::marker", "Line", [("p::marker", "Text", "• ")])],
                            ),
                            (
                                "p::before",
                                "Block",
                                [("p::before", "Line", [("p::before", "Text", "a")])],
                            ),
                        ],
                    )
                ],
...
def test_counter_styles_3():
    ...
    assert (
        [
            counters.format(value, "decimal-leading-zero")
            for value in [
                -1986,
                -1985,
                -11,
...
def test_counter_styles_4():
    ...
    assert (
        [
            counters.format(value, "lower-roman")
            for value in [
                -1986,
                -1985,
                -1,
...
def test_counter_styles_5():
    ...
    assert (
        [
            counters.format(value, "upper-roman")
            for value in [
                -1986,
                -1985,
                -1,
...
def test_counter_styles_6():
    assert (
        [
            counters.format(value, "lower-alpha")
            for value in [
                -1986,
                -1985,
                -1,
...
def test_counter_styles_7():
    assert (
        [
            counters.format(value, "upper-alpha")
            for value in [
                -1986,
                -1985,
                -1,
...
def test_counter_styles_8():
    assert (
        [
            counters.format(value, "lower-latin")
            for value in [
                -1986,
                -1985,
                -1,
...
def test_counter_styles_9():
    assert (
        [
            counters.format(value, "upper-latin")
            for value in [
                -1986,
                -1985,
                -1,
...
def test_counter_styles_10():
    ...
    assert (
        [
            counters.format(value, "georgian")
            for value in [
                -1986,
                -1985,
                -1,
...
def test_counter_styles_11():
    ...
    assert (
        [
            counters.format(value, "armenian")
            for value in [
                -1986,
                -1985,
                -1,
