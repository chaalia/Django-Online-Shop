...
def test_images_3():
    ...
    for url in [
        ...
        "data:image/svg+xml;base64," "R0lGODlhAQABAIABAP///wAAACwAAAAAAQABAAACAkQBADs=",
        "really-a-png.svg",
    ]:
...
def test_images_4():
    ...
    for url in [
        ...
        "data:image/jpeg;base64," "R0lGODlhAQABAIABAP///wAAACwAAAAAAQABAAACAkQBADs=",
        # GIF with PNG mimetype
        "data:image/png;base64," "R0lGODlhAQABAIABAP///wAAACwAAAAAAQABAAACAkQBADs=",
...
def test_images_8():
    ...
    body, img = get_img(
        """<body style="font-size: 0"><p style="width: 200px">
...
def test_linear_gradient():
    ...
    layout(
        "repeating-linear-gradient(blue, lime 1.5px)", "solid", (0, 0.5, 0.5, 1), [], []
    )
    ...
    layout(
        "repeating-linear-gradient(blue, lime 20px)",
        "solid",
        (0, 0.5, 0.5, 1),
        [],
        [],
    ...
    layout("linear-gradient(to top left, blue, lime)", init=(344, 342, 56, -42))
    layout("linear-gradient(to top right, blue, lime)", init=(56, 342, 344, -42))
    layout("linear-gradient(to bottom left, blue, lime)", init=(344, -42, 56, 342))
    layout("linear-gradient(to bottom right, blue, lime)", init=(56, -42, 344, 342))
    ...
    layout(
        "linear-gradient(blue 100px, red, blue, red 160px, lime)",
        init=(200, 100, 200, 300),
        colors=[blue, red, blue, red, lime],
        positions=[0, 0.1, 0.2, 0.3, 1],
    )
    layout(
        "linear-gradient(blue -100px, blue 0, red -12px, lime 50%)",
        init=(200, -100, 200, 150),
        colors=[blue, blue, red, lime],
        positions=[0, 0.4, 0.4, 1],
    )
    layout(
        "linear-gradient(blue, blue, red, lime -7px)",
        init=(200, 0, 200, 100),
        colors=[blue, blue, red, lime],
        positions=[0, 0, 0, 0],
    )
    layout(
        "repeating-linear-gradient(blue, blue, lime, lime -7px)",
        "solid",
        (0, 0.5, 0.5, 1),
        [],
        [],
...
def test_radial_gradient():
    ...
    layout("radial-gradient(100px, blue, lime)", init=(200, 150, 0, 100))

    layout(
        "radial-gradient(100px at right 20px bottom 30px, lime, red)",
        init=(380, 270, 0, 100),
        colors=[lime, red],
    )
    layout("radial-gradient(0 0, blue, lime)", init=(200, 150, 0, 1e-7))
    layout("radial-gradient(1px 0, blue, lime)", init=(200, 150, 0, 1e7), scale_y=1e-14)
    layout("radial-gradient(0 1px, blue, lime)", init=(200, 150, 0, 1e-7), scale_y=1e14)
    layout(
        "repeating-radial-gradient(20px 40px, blue, lime)",
        init=(200, 150, 0, 20),
        scale_y=(40 / 20),
    )
    layout(
    ...
    layout(
        "repeating-radial-gradient(42px, blue -20px, lime 10px)",
        init=(200, 150, 10, 40),
    )
    layout(
        "repeating-radial-gradient(42px, blue -140px, lime -110px)",
        init=(200, 150, 10, 40),
    )
    layout("radial-gradient(42px, blue -20px, lime -1px)", "solid", lime, [], [])
    layout("radial-gradient(42px, blue -20px, lime 0)", "solid", lime, [], [])
    layout(
        "radial-gradient(42px, blue -20px, lime 20px)",
        init=(200, 150, 0, 20),
        colors=[(0, 0.5, 0.5, 1), lime],
    )

    layout(
        "radial-gradient(100px 120px, blue, lime)",
        init=(200, 150, 0, 100),
        scale_y=(120 / 100),
    )
    layout(
        "radial-gradient(25% 40%, blue, lime)",
        init=(200, 150, 0, 100),
        scale_y=(120 / 100),
    )

    layout("radial-gradient(circle closest-side, blue, lime)", init=(200, 150, 0, 150))
    layout(
        "radial-gradient(circle closest-side at 150px 50px, blue, lime)",
        init=(150, 50, 0, 50),
    )
    layout(
        "radial-gradient(circle closest-side at 45px 50px, blue, lime)",
        init=(45, 50, 0, 45),
    )
    layout(
        "radial-gradient(circle closest-side at 420px 50px, blue, lime)",
        init=(420, 50, 0, 20),
    )
    layout(
        "radial-gradient(circle closest-side at 420px 281px, blue, lime)",
        init=(420, 281, 0, 19),
    )

    layout(
        "radial-gradient(closest-side, blue 20%, lime)",
        init=(200, 150, 40, 200),
        scale_y=(150 / 200),
    )
    layout(
        "radial-gradient(closest-side at 300px 20%, blue, lime)",
        init=(300, 60, 0, 100),
        scale_y=(60 / 100),
    )
    layout(
        "radial-gradient(closest-side at 10% 230px, blue, lime)",
        init=(40, 230, 0, 40),
        scale_y=(70 / 40),
    )

    layout("radial-gradient(circle farthest-side, blue, lime)", init=(200, 150, 0, 200))
    layout(
        "radial-gradient(circle farthest-side at 150px 50px, blue, lime)",
        init=(150, 50, 0, 250),
    )
    layout(
        "radial-gradient(circle farthest-side at 45px 50px, blue, lime)",
        init=(45, 50, 0, 355),
    )
    layout(
        "radial-gradient(circle farthest-side at 420px 50px, blue, lime)",
        init=(420, 50, 0, 420),
    )
    layout(
        "radial-gradient(circle farthest-side at 220px 310px, blue, lime)",
        init=(220, 310, 0, 310),
    )

    layout(
        "radial-gradient(farthest-side, blue, lime)",
        init=(200, 150, 0, 200),
        scale_y=(150 / 200),
    )
    layout(
        "radial-gradient(farthest-side at 300px 20%, blue, lime)",
        init=(300, 60, 0, 300),
        scale_y=(240 / 300),
    )
    layout(
        "radial-gradient(farthest-side at 10% 230px, blue, lime)",
        init=(40, 230, 0, 360),
        scale_y=(230 / 360),
    )

    layout(
        "radial-gradient(circle closest-corner, blue, lime)", init=(200, 150, 0, 250)
    )
    layout(
        "radial-gradient(circle closest-corner at 340px 80px, blue, lime)",
        init=(340, 80, 0, 100),
    )
    layout(
        "radial-gradient(circle closest-corner at 0 342px, blue, lime)",
        init=(0, 342, 0, 42),
    )

    layout(
        "radial-gradient(closest-corner, blue, lime)",
        init=(200, 150, 0, 200 * 2 ** 0.5),
        scale_y=(150 / 200),
    )
    layout(
        "radial-gradient(closest-corner at 450px 100px, blue, lime)",
        init=(450, 100, 0, 50 * 2 ** 0.5),
        scale_y=(100 / 50),
    )
    layout(
        "radial-gradient(closest-corner at 40px 210px, blue, lime)",
        init=(40, 210, 0, 40 * 2 ** 0.5),
        scale_y=(90 / 40),
    )

    layout(
        "radial-gradient(circle farthest-corner, blue, lime)", init=(200, 150, 0, 250)
    )
    layout(
        "radial-gradient(circle farthest-corner" " at 300px -100px, blue, lime)",
        init=(300, -100, 0, 500),
    )
    layout(
        "radial-gradient(circle farthest-corner at 400px 0, blue, lime)",
        init=(400, 0, 0, 500),
    )

    layout(
        "radial-gradient(farthest-corner, blue, lime)",
        init=(200, 150, 0, 200 * 2 ** 0.5),
        scale_y=(150 / 200),
    )
    layout(
        "radial-gradient(farthest-corner at 450px 100px, blue, lime)",
        init=(450, 100, 0, 450 * 2 ** 0.5),
        scale_y=(200 / 450),
    )
    layout(
        "radial-gradient(farthest-corner at 40px 210px, blue, lime)",
        init=(40, 210, 0, 360 * 2 ** 0.5),
        scale_y=(210 / 360),
    )
