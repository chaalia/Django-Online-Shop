...
from .testing_utils import assert_no_logs, capture_logs, requires, resource_filename
...
def test_acid2():
    ...
    with capture_logs():
        ...
        test_image, width, height = document.copy([test_page]).write_image_surface()
    ...
    assert_pixels_equal(
        ...
        width,
        height,
        image_to_pixels(test_image, width, height),
        image_to_pixels(ref_image, width, height),
        tolerance=2,
    )
