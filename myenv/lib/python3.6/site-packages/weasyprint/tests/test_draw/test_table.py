...
def test_tables_7():
    assert_pixels(
        "table_borders_and_row_backgrounds",
        28,
        28,
        to_pix(
            """
...
def test_tables_8():
    assert_pixels(
        "table_borders_and_column_backgrounds",
        28,
        28,
        to_pix(
            """
