            ...
            [
              ...
              <div>%s</div>"""
                ...
                for name, html in [
                    ...
                    ("image_alt_text_no_src", '<img alt="Hello, world!">'),
                    (
