...
def columns_layout(
    ...
    if height != "auto" and height.unit != "%":
        ...
        known_height = True
        max_position_y = min(max_position_y, box.content_box_y() + height.value)
    else:
        known_height = False
    ...
    if style["column_width"] == "auto" and style["column_count"] != "auto":
        ...
        width = max(0, available_width - (count - 1) * style["column_gap"]) / count
        ...
        width = (available_width + style["column_gap"]) / count - style["column_gap"]
    else:
        count = min(
            style["column_count"],
            int(
    ...
    for column_children_or_block in columns_and_blocks:
        ...
        while True:
            ...
            new_excluded_shapes = len(context.excluded_shapes) - len(excluded_shapes)
        ...
        while True:
            ...
            new_child, column_skip_stack, column_next_page, _, _ = block_box_layout(
                context,
                column_box,
                max_position_y,
                skip_stack,
