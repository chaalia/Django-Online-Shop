...
def block_box_layout(
    ...
    new_box, resume_at, next_page, adjoining_margins, collapsing_through = block_container_layout(
        context,
        box,
        max_position_y,
        skip_stack,
...
def block_level_width(box, containing_block):
    ...
    if margin_l == "auto" and margin_r == "auto":
        box.margin_left = margin_sum / 2.0
        box.margin_right = margin_sum / 2.0
...
def block_container_layout(
    ...
    for i, child in enumerate(box.children[skip:]):
        ...
        if not child.is_in_normal_flow():
            ...
            if child.is_absolutely_positioned():
                ...
                if (page_is_empty and not new_children) or not (
                    new_child.position_y + new_child.height > allowed_max_position_y
                ):
        ...
        if isinstance(child, boxes.LineBox):
            ...
            for line, resume_at in lines_iterator:
                ...
                # box if needed
                if resume_at is None or (box.style["box_decoration_break"] == "clone"):
            ...
            if not new_containing_block.is_table_wrapper:
                ...
                if (
                    ...
                    and last_in_flow_child is None
            ...
            if new_child is not None:
                ...
                if not isinstance(new_child, (boxes.BlockBox, boxes.TableBox)):
                    ...
                    offset_y = collapse_margin(adjoining_margins) - new_child.margin_top
                ...
                if not collapsing_through:
                    ...
                    if (
                        new_position_y > allowed_max_position_y
                        and not page_is_empty_with_no_children
                    ):
    ...
    if (
        ...
        and box.style["break_inside"] in ("avoid", "avoid-page")
...
def establishes_formatting_context(box):
    ...
    return (
        (box.is_floated())
        or (box.is_absolutely_positioned())
        or (
        ...
        or (isinstance(box, boxes.BlockBox) and box.style["overflow"] != "visible")
    )
