...
def absolute_width(box, context, containing_block):
    ...
    if left == right == width == "auto":
        ...
        width_for_margins = cb_width - (right + left + padding_plus_borders_x)
        ...
        if left == width == "auto":
            box.width = shrink_to_fit(context, box, cb_width - spacing - right)
            ...
            translate_x = cb_width + default_translate_x - right - spacing - width
        elif width == "auto":
...
def absolute_height(box, context, containing_block):
    ...
    if top == bottom == height == "auto":
        ...
        height_for_margins = cb_height - (top + bottom + paddings_plus_borders_y)
...
def absolute_block(context, box, containing_block, fixed_boxes):
    ...
    translate_box_width, translate_x = absolute_width(box, context, containing_block)
    translate_box_height, translate_y = absolute_height(box, context, containing_block)
...
def absolute_flex(context, box, containing_block_sizes, fixed_boxes, containing_block):
    # Avoid a circular import
...
def absolute_box_layout(context, box, containing_block, fixed_boxes):
    ...
    if isinstance(box, boxes.BlockBox):
        ...
        new_box = absolute_flex(context, box, containing_block, fixed_boxes, cb)
    else:
