...
def percentage(value, refer_to):
    ...
    if value is None or value == "auto":
        ...
        assert value.unit == "%"
        return refer_to * value.value / 100.0
...
def resolve_one_percentage(box, property_name, refer_to, main_flex_direction=None):
    ...
    if property_name in ("min_width", "min_height") and percent == "auto":
        if main_flex_direction is None or property_name != (
            "min_%s" % main_flex_direction
        ):
...
def resolve_percentages(box, containing_block, main_flex_direction=None):
    ...
    if cb_height == "auto":
        ...
        resolve_one_percentage(box, "max_height", float("inf"), main_flex_direction)
    else:
