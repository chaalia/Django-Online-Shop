...
_lr_action_items = {
    ...
    "PPHASH": (
        [0, 12, 14, 17, 23, 26, 34, 40, 42, 53, 68, 101, 104, 120, 131, 258, 353],
        [
            42,
            -64,
            -60,
...
_lr_goto_items = {
    "expression_statement": (
        [121, 215, 224, 342, 351, 354, 439, 479, 481, 483, 517, 522, 526],
    ...
    "init_declarator_list": ([33, 63], [82, 82]),
    "init_declarator_list_opt": ([33, 63], [90, 90]),
    "iteration_statement": (
        [121, 215, 224, 342, 351, 354, 439, 479, 481, 483, 517, 522, 526],
    ...
    "assignment_expression_opt": ([106, 198, 253, 330, 422], [163, 328, 366, 429, 468]),
    "brace_open": (
        [
            27,
            28,
    ...
    "enumerator": ([75, 134, 135, 248], [136, 136, 136, 364]),
    "typeid_noparen_declarator": ([113], [197]),
    "type_qualifier_list_opt": (
        [31, 59, 108, 144, 255, 326, 424],
        [77, 106, 186, 253, 369, 422, 471],
    ),
    "declaration_specifiers_no_type_opt": ([1, 47, 49], [55, 102, 103]),
    "expression_opt": (
        [
            121,
            215,
    ...
    "designation": ([260, 454, 466, 510], [372, 372, 372, 372]),
    "parameter_list": ([60, 145, 189, 327, 331, 398], [116, 116, 116, 116, 116, 116]),
    "labeled_statement": (
        [121, 215, 224, 342, 351, 354, 439, 479, 481, 483, 517, 522, 526],
        [206, 206, 206, 206, 206, 206, 206, 206, 206, 206, 206, 206, 206],
    ),
    "abstract_declarator": ([113, 189, 296, 398], [191, 323, 191, 323]),
    "translation_unit": ([0], [26]),
    "init_declarator": ([33, 63, 142, 149], [94, 94, 252, 263]),
    "direct_abstract_declarator": (
        [113, 189, 192, 296, 319, 397, 398],
        [199, 199, 325, 199, 325, 325, 199],
    ),
    "designator_list": ([260, 454, 466, 510], [379, 379, 379, 379]),
    "identifier": (
        [
            60,
            106,
    ...
    "offsetof_member_designator": ([462], [491]),
    "unary_expression": (
        [
            106,
            121,
    ...
    "abstract_declarator_opt": ([113, 296], [190, 396]),
    "initializer": ([147, 148, 378, 487], [259, 262, 455, 506]),
    "direct_id_declarator": (
        [0, 4, 13, 26, 33, 36, 63, 65, 81, 84, 113, 133, 142, 149, 189, 192, 319, 359],
        [8, 8, 61, 8, 8, 8, 8, 8, 8, 61, 8, 8, 8, 8, 8, 61, 61, 8],
    ),
    "struct_declaration_list": ([72, 123, 124], [125, 231, 233]),
    "pp_directive": ([0, 26], [12, 12]),
    "declaration_list": ([18, 87], [67, 67]),
    "id_init_declarator": ([36, 65], [95, 95]),
    "type_specifier": (
        [
            0,
            18,
    ...
    "compound_statement": (
        [66, 121, 146, 215, 224, 342, 351, 354, 439, 479, 481, 483, 517, 522, 526],
        [120, 208, 258, 208, 208, 208, 208, 208, 208, 208, 208, 208, 208, 208, 208],
    ),
    "pointer": (
        [0, 4, 26, 33, 36, 63, 65, 77, 81, 113, 133, 142, 149, 189, 296, 359, 398],
        [13, 13, 13, 84, 13, 84, 13, 140, 84, 192, 84, 84, 84, 319, 397, 84, 397],
    ),
    "typeid_declarator": (
        [33, 63, 81, 133, 142, 149, 359],
        [86, 86, 141, 86, 86, 86, 86],
    ),
    "id_init_declarator_list": ([36, 65], [98, 98]),
    "declarator": ([33, 63, 133, 142, 149, 359], [89, 89, 245, 89, 89, 245]),
    "argument_expression_list": ([285], [390]),
    "struct_declarator_list_opt": ([133], [242]),
    "typedef_name": (
        [
            0,
            18,
    ...
    "parameter_type_list_opt": ([189, 331, 398], [322, 431, 322]),
    "struct_declarator": ([133, 359], [243, 445]),
    "type_qualifier": (
        [
            0,
            1,
    ...
    "storage_class_specifier": (
        ...
        [1, 1, 1, 1, 80, 1, 1, 1, 80, 1, 1, 80, 1, 1, 1, 1, 1, 1, 1, 1, 1],
    ),
    "unified_wstring_literal": (
        [
            106,
    ...
    "translation_unit_or_empty": ([0], [43]),
    "initializer_list_opt": ([260], [373]),
    "brace_close": (
        [72, 123, 124, 125, 137, 226, 231, 233, 246, 247, 373, 454, 493, 510],
        [126, 232, 234, 235, 249, 353, 356, 357, 362, 363, 451, 489, 511, 520],
    ),
    "direct_typeid_declarator": (
        [33, 63, 81, 84, 133, 142, 149, 359],
        [85, 85, 85, 143, 85, 85, 85, 85],
    ),
    "external_declaration": ([0, 26], [14, 68]),
    "pragmacomp_or_statement": (
        [224, 342, 354, 439, 479, 481, 483, 517, 522, 526],
        [350, 437, 443, 480, 501, 502, 504, 524, 527, 528],
    ),
    "type_name": ([173, 277, 287, 288, 291], [295, 382, 391, 392, 393]),
    "block_item_list": ([121], [215]),
    "pppragma_directive": (
        [
            0,
            26,
    ...
    "statement": (
        [121, 215, 224, 342, 351, 354, 439, 479, 481, 483, 517, 522, 526],
        [218, 218, 352, 352, 442, 352, 352, 352, 352, 505, 352, 352, 352],
    ),
    "cast_expression": (
        [
            106,
    ...
    "struct_declarator_list": ([133], [240]),
    "empty": (
        [
            0,
            1,
    ...
    "parameter_declaration": (
        [60, 145, 189, 201, 327, 331, 398],
        [112, 112, 112, 334, 112, 112, 112],
    ),
    "primary_expression": (
        [
            106,
    ...
    "declaration": (
        [0, 18, 26, 67, 87, 121, 215, 339],
        [34, 64, 34, 122, 64, 219, 219, 435],
    ),
    "declaration_specifiers_no_type": (
        [0, 1, 18, 26, 47, 49, 60, 67, 87, 121, 145, 189, 201, 215, 327, 331, 339, 398],
        [36, 56, 65, 36, 56, 56, 117, 65, 65, 65, 117, 117, 117, 65, 117, 117, 65, 117],
    ),
    "jump_statement": (
        [121, 215, 224, 342, 351, 354, 439, 479, 481, 483, 517, 522, 526],
        [220, 220, 220, 220, 220, 220, 220, 220, 220, 220, 220, 220, 220],
    ),
    "enumerator_list": ([75, 134, 135], [137, 246, 247]),
    "block_item": ([121, 215], [222, 346]),
    "constant_expression": ([214, 239, 250, 361, 376], [344, 358, 365, 446, 453]),
    "identifier_list_opt": ([60, 145, 327], [109, 256, 425]),
    "constant": (
        [
            106,
            121,
    ...
    "struct_declaration": (
        [72, 123, 124, 125, 231, 233],
        [130, 130, 130, 236, 236, 236],
    ),
    "direct_typeid_noparen_declarator": ([113, 192], [193, 324]),
    "id_declarator": (
        [0, 4, 26, 33, 36, 63, 65, 81, 113, 133, 142, 149, 189, 359],
        [18, 58, 18, 87, 97, 119, 97, 58, 194, 119, 119, 119, 58, 119],
    ),
    "selection_statement": (
        [121, 215, 224, 342, 351, 354, 439, 479, 481, 483, 517, 522, 526],
    ...
    "initializer_list": ([260, 466], [377, 493]),
    "unary_operator": (
        [
            106,
            121,
    ...
    "designation_opt": ([260, 454, 466, 510], [378, 487, 378, 487]),
    "parameter_type_list": (
        [60, 145, 189, 327, 331, 398],
        [111, 257, 321, 426, 321, 321],
    ),
    "type_qualifier_list": (
        [
            31,
    ...
    "designator": ([260, 379, 454, 466, 510], [374, 456, 374, 374, 374]),
    "id_init_declarator_list_opt": ([36, 65], [99, 99]),
    "declaration_specifiers": (
        [0, 18, 26, 60, 67, 87, 121, 145, 189, 201, 215, 327, 331, 339, 398],
        [33, 63, 33, 113, 63, 63, 63, 113, 113, 113, 63, 113, 113, 63, 113],
    ),
    "identifier_list": ([60, 145, 327], [114, 114, 114]),
    "declaration_list_opt": ([18, 87], [66, 146]),
    "function_definition": ([0, 26], [40, 40]),
    "binary_expression": (
        [
            106,
            121,
    ...
    "decl_body": ([0, 18, 26, 67, 87, 121, 215, 339], [46, 46, 46, 46, 46, 46, 46, 46]),
    "function_specifier": (
        [
            0,
            1,
    ...
    "specifier_qualifier_list": (
        [72, 123, 124, 125, 173, 231, 233, 277, 287, 288, 291],
        [133, 133, 133, 133, 296, 133, 133, 296, 296, 296, 296],
    ),
