    ...
    def _prepare(self, reply):
        if reply:
            ...
            if self.pattern:
                ...
                return {
                    node: reply
                    for node, reply in items(by_node)
...
class Control(object):
    ...
    def election(self, id, topic, action=None, connection=None):
        self.broadcast(
            ...
            destination=None,
            arguments={"id": id, "topic": topic, "action": action},
        )
    ...
    def revoke(
        ...
        return self.broadcast(
            ...
            arguments={"task_id": task_id, "terminate": terminate, "signal": signal},
            **kwargs
        )
    ...
    def rate_limit(self, task_name, rate_limit, destination=None, **kwargs):
        ...
        return self.broadcast(
            "rate_limit",
            destination=destination,
            arguments={"task_name": task_name, "rate_limit": rate_limit},
            **kwargs
        )
    ...
    def time_limit(self, task_name, soft=None, hard=None, destination=None, **kwargs):
        ...
        return self.broadcast(
            "time_limit",
            arguments={"task_name": task_name, "hard": hard, "soft": soft},
            destination=destination,
            **kwargs
        )
    ...
    def pool_restart(
        ...
        return self.broadcast(
            "pool_restart",
            arguments={"modules": modules, "reload": reload, "reloader": reloader},
            destination=destination,
            **kwargs
        )
