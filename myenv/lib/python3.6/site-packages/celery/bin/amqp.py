...
class Spec(object):
    ...
    def str_args_to_python(self, arglist):
        ...
        Example:
            ...
            ('pobox', True)
        """
        return tuple(self.coerce(index, value) for index, value in enumerate(arglist))
    ...
    def format_arg(self, name, type, default_value=None):
        if default_value is not None:
            return "{}:{}".format(name, default_value)
        return name

    def format_signature(self):
        return " ".join(self.format_arg(*padlist(list(arg), 3)) for arg in self.args)
...
class AMQShell(_cmd.Cmd):
    ...
    builtins = {"EOF": "do_exit", "exit": "do_exit", "help": "do_help"}

    #: Map of AMQP API commands and their :class:`Spec`.
    amqp = {
        "exchange.declare": Spec(
            ("exchange", str),
            ("type", str),
            ("passive", bool, "no"),
            ("durable", bool, "no"),
        ...
        "exchange.delete": Spec(("exchange", str), ("if_unused", bool)),
        "queue.bind": Spec(("queue", str), ("exchange", str), ("routing_key", str)),
        "queue.declare": Spec(
            ("queue", str),
            ("passive", bool, "no"),
            ("durable", bool, "no"),
        ...
        "queue.purge": Spec(("queue", str), returns="ok. {0} messages deleted."),
        "basic.get": Spec(
            ("queue", str), ("no_ack", bool, "off"), returns=dump_message
        ),
        "basic.publish": Spec(
            ("msg", str),
            ("exchange", str),
    ...
    def default(self, line):
        self.say("unknown syntax: {!r}. how about some 'help'?".format(line))
