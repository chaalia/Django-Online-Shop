...
class migrate(Command):
    ...
    def add_arguments(self, parser):
        ...
        group.add_argument(
            "--limit", "-n", type=int, help="Number of tasks to consume (int)"
        )
        group.add_argument(
            "--timeout",
            "-t",
        ...
        group.add_argument("--tasks", "-T", help="List of task names to filter on.")
        group.add_argument("--queues", "-Q", help="List of queues to migrate.")
        group.add_argument(
            "--forever",
            "-F",
            action="store_true",
