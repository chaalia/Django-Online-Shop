...
class events(Command):
    ...
    def set_process_status(self, prog, info=""):
        prog = "{}:{}".format(self.prog_name, prog)
    ...
    def add_arguments(self, parser):
        ...
        copts.add_argument("-F", "--frequency", "--freq", type=float, default=1.0)
        ...
        if user_options:
            self.add_compat_options(
                parser.add_argument_group("User Options"), user_options
            )
