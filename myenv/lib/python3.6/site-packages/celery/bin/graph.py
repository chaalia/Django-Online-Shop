    ...
    def workers(self, *args, **kwargs):
        ...
        class Thread(Node):
            ...
            def __init__(self, label, **kwargs):
                ...
                super(Thread, self).__init__(label="thr-{}".format(next(tids)), pos=0)
        ...
        class Formatter(GraphFormatter):
            ...
            def node(self, obj):
                ...
                return self.draw_node(obj, dict(self.node_scheme, **scheme))
        ...
        for i, threads in enumerate(threads):
            threads_for[workers[i]] = maybe_abbr(list(range(int(threads))), "P", Tmax)
