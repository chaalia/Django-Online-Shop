...
class call(Command):
    ...
    def add_arguments(self, parser):
        ...
        group.add_argument("--args", "-a", help="positional arguments (json).")
        group.add_argument("--kwargs", "-k", help="keyword arguments (json).")
        group.add_argument("--eta", help="scheduled time (ISO-8601).")
        group.add_argument(
            "--countdown", type=float, help="eta in seconds from now (float/int)."
        )
        group.add_argument("--expires", help="expiry time (ISO-8601/float/int)."),
        group.add_argument("--serializer", default="json", help="defaults to json."),
