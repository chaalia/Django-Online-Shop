...
test_worker_starting = Signal(name="test_worker_starting", providing_args={})
test_worker_started = Signal(
    name="test_worker_started", providing_args={"worker", "consumer"}
)
test_worker_stopped = Signal(name="test_worker_stopped", providing_args={"worker"})
