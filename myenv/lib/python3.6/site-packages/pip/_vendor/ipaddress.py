...
def summarize_address_range(first, last):
    ...
    if first.version != last.version:
        raise TypeError("{} and {} are not of the same version".format(first, last))
    if first > last:
    ...
    for ip in addresses:
        if isinstance(ip, _BaseAddress):
            if ips and ips[-1]._version != ip._version:
                raise TypeError(
                    "{} and {} are not of the same version".format(ip, ips[-1])
                )
            ips.append(ip)
            ...
            if nets and nets[-1]._version != ip._version:
                raise TypeError(
                    "{} and {} are not of the same version".format(ip, nets[-1])
                )
            nets.append(ip)
...
class _IPAddressBase(_TotalOrderingMixin):
    ...
    @property
    def version(self):
        msg = "{:>200} has no version specified".format(type(self))
...
class _BaseAddress(_IPAddressBase):
    ...
    def __lt__(self, other):
        ...
        if not isinstance(other, _BaseAddress):
            raise TypeError("{} and {} are not of the same type".format(self, other))
        if self._version != other._version:
            raise TypeError("{} and {} are not of the same version".format(self, other))
    ...
    def __repr__(self):
        return "{}({!r})".format(self.__class__.__name__, _compat_str(self))
...
class _BaseNetwork(_IPAddressBase):
    ...
    def with_netmask(self):
        return "{}/{}".format(self.network_address, self.netmask)

    @property
    def with_hostmask(self):
        return "{}/{}".format(self.network_address, self.hostmask)
    ...
    def _address_class(self):
        ...
        msg = "{:>200} has no associated address class".format(type(self))
        raise NotImplementedError(msg)
    ...
    def address_exclude(self, other):
        ...
        if not other.subnet_of(self):
            raise ValueError("{} not contained in {}".format(other, self))
        if other == self:
            return

        # Make sure we're comparing the network of other.
        other = other.__class__("{}/{}".format(other.network_address, other.prefixlen))
...
class _BaseV4(object):
    ...
    def _ip_int_from_string(cls, ip_str):
        ...
        try:
            ...
            raise AddressValueError("{} in {!r}".format(exc, ip_str))
...
class IPv4Interface(IPv4Address):
    ...
    @property
    def with_prefixlen(self):
        return "{}/{}".format(self._string_from_ip_int(self._ip), self._prefixlen)

    @property
    def with_netmask(self):
        return "{}/{}".format(self._string_from_ip_int(self._ip), self.netmask)

    @property
    def with_hostmask(self):
        return "{}/{}".format(self._string_from_ip_int(self._ip), self.hostmask)
