    ...
    if SYSTEM == "Darwin" and ctypes is not None:
        ...
        try:
            ...
            try:
                ...
                error = OSError(
                    "Could not detect working librt library: {}".format(exc)
                )
...
if PY3:  # pragma: no cover
    ...
    from itertools import imap as map, izip as zip, izip_longest as zip_longest  # noqa
...
def with_metaclass(Type, skip_attrs=None):
    ...
    def _clone_with_metaclass(Class):
        attrs = {
            key: value for key, value in items(vars(Class)) if key not in skip_attrs
        }
    ...
    if PY2:
        try:
            ...
            def __repr__(self, *args, **kwargs):
                return self.__unicode_repr__(*args, **kwargs).encode("utf-8", "replace")
    ...
    if PY2:
        try:
            ...
            def __str__(self, *args, **kwargs):
                return self.__unicode__(*args, **kwargs).encode("utf-8", "replace")
