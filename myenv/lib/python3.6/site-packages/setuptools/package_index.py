...
class PackageIndex(Environment):
    ...
    def open_url(self, url, warning=None):
        ...
        try:
            ...
            if warning:
                ...
                raise DistutilsError("Download error for {}: {}".format(url, v.reason))
            ...
            if warning:
                ...
                raise DistutilsError("Download error for {}: {}".format(url, v))
    ...
    def _download_git(self, url, filename):
        ...
        if rev is not None:
            ...
            os.system("git -C {} checkout --quiet {}".format(filename, rev))
    ...
    def _download_hg(self, url, filename):
        ...
        if rev is not None:
            ...
            os.system("hg --cwd {} up -C -r {} -q".format(filename, rev))
