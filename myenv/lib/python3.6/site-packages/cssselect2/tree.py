...
class ElementWrapper(object):
    ...
    def in_disabled_fieldset(self):
        if self.parent is None:
            return False
        if (
            self.parent.etree_element.tag == ("{http://www.w3.org/1999/xhtml}fieldset")
            and self.parent.etree_element.get("disabled") is not None
            and (
                self.etree_element.tag != ("{http://www.w3.org/1999/xhtml}legend")
                or any(
                    s.etree_element.tag == ("{http://www.w3.org/1999/xhtml}legend")
