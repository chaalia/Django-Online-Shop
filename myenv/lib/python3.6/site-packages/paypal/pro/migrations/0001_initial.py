        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "street",
                    models.CharField(
                        max_length=255, verbose_name="Street Address", blank=True
                    ),
                ),
                (
                    "city",
                ...
                (
                    "state",
                    models.CharField(max_length=255, verbose_name="State", blank=True),
                ),
                (
                    "countrycode",
                    models.CharField(max_length=2, verbose_name="Country", blank=True),
                ),
                (
                    "zip",
                    models.CharField(
                        max_length=32, verbose_name="Postal / Zip Code", blank=True
                    ),
                ),
            ...
            options={"db_table": "paypal_nvp", "verbose_name": "PayPal NVP"},
            bases=(models.Model,),
        )
    ]
