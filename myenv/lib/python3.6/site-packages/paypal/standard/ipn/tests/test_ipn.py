...
class IPNTest(MockedPostbackMixin, IPNUtilsMixin, TestCase):
    def test_valid_ipn_received(self):
        ...
        self.assertEqual(ipn_obj.first_name, "J\u00f6rg")
        # Check date parsing
        self.assertEqual(
            ipn_obj.payment_date,
            datetime(
                2009, 2, 3, 7, 4, 6, tzinfo=timezone.utc if settings.USE_TZ else None
            ),
        )
    ...
    def test_posted_params_attribute(self):
        ...
        self.assertEqual(ipn.posted_data_dict["first_name"], "J\u00f6rg")
