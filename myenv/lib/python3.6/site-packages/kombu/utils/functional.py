...
from kombu.five import UserDict, items, keys, python_2_unicode_compatible, string_t, PY3
...
def accepts_argument(func, argument_name):
    if PY3:
        ...
        return (
            argument_name in argument_spec.args
            or argument_name in argument_spec.kwonlyargs
        )
