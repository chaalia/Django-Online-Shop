...
binding_key_t = namedtuple("binding_key_t", ("queue", "exchange", "routing_key"))

#: BrokerState.queue_bindings generates tuples in this format.
queue_binding_t = namedtuple(
    "queue_binding_t", ("exchange", "routing_key", "arguments")
)
...
class Channel(AbstractChannel, base.StdChannel):
    ...
    def _inplace_augment_message(self, message, exchange, routing_key):
        ...
        props.update(
            body_encoding=body_encoding, delivery_tag=self._next_delivery_tag()
        )
    ...
    def _lookup(self, exchange, routing_key, default=None):
        ...
        try:
            R = self.typeof(exchange).lookup(
                self.get_table(exchange), exchange, routing_key, default
            )
        except KeyError:
            R = []
...
class Transport(base.Transport):
    ...
    def __init__(self, client, **kwargs):
        ...
        self._avail_channel_ids = array(ARRAY_TYPE_H, range(self.channel_max, 0, -1))
