...
class Channel(base.StdChannel):
    ...
    def _purge(self, queue):
        ...
        if queue_to_purge is None:
            error_text = "NOT_FOUND - no queue '{}'".format(queue)
    ...
    def basic_publish(self, message, exchange, routing_key, **kwargs):
        ...
        props.update(body_encoding=body_encoding, delivery_tag=uuid.uuid4())
...
class Transport(base.Transport):
    ...
    recoverable_connection_errors = (ConnectionError, select.error)
    ...
    def default_connection_params(self):
        ...
        """
        return {"hostname": "localhost", "port": 5672}
