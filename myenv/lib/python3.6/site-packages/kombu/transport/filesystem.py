...
class Channel(virtual.Channel):
    ...
    def _put(self, queue, payload, **kwargs):
        ...
        try:
            ...
            raise ChannelError("Cannot add file {!r} to directory".format(filename))
        finally:
            unlock(f)
            f.close()
    ...
    def _get(self, queue):
        ...
        while len(folder) > 0:
            ...
            try:
                ...
                raise ChannelError("Cannot read file {!r} from queue.".format(filename))
