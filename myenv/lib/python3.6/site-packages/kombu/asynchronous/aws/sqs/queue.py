...
class AsyncQueue:
    ...
    def get_attributes(self, attributes="All", callback=None):
        return self.connection.get_queue_attributes(self, attributes, callback)

    def set_attribute(self, attribute, value, callback=None):
        return self.connection.set_queue_attribute(self, attribute, value, callback)

    def get_timeout(self, callback=None, _attr="VisibilityTimeout"):
        return self.get_attributes(
            _attr, transform(self._coerce_field_value, callback, _attr, int)
        )
    ...
    def set_timeout(self, visibility_timeout, callback=None):
        return self.set_attribute(
            "VisibilityTimeout",
            visibility_timeout,
            transform(self._on_timeout_set, callback),
        )
    ...
    def write_batch(self, messages, callback=None):
        return self.connection.send_message_batch(self, messages, callback=callback)
    ...
    def delete_message_batch(self, messages, callback=None):
        return self.connection.delete_message_batch(self, messages, callback=callback)
    ...
    def count(
        ...
        return self.get_attributes(
            _attr, callback=transform(self._coerce_field_value, callback, _attr, int)
        )
