        ...
        if backend is None:
            ...
            if backend.__version__ != __version__:
                ...
                if hasattr(backend, "__file__"):
                    # CPython
                    raise Exception(
                        "Version mismatch: this is the 'cffi' package version {}, located in {!r}.  When we import the top-level '_cffi_backend' extension module, we get version {}, located in {!r}.  The two versions should be equal; check your installation.".format(
                    ...
                    # PyPy
                    raise Exception(
                        "Version mismatch: this is the 'cffi' package version {}, located in {!r}.  This interpreter comes with a built-in '_cffi_backend' module, which is version {}.  The two versions should be equal; check your installation.".format(
...
def _load_backend_lib(backend, name, flags):
    ...
    if path is None:
        ...
        if first_error is not None:
            msg = "{}.  Additionally, {}".format(first_error, msg)
        raise OSError(msg)
