...
class CTypesData(object):
    ...
    def __init__(self, *args):
        raise TypeError("cannot instantiate {!r}".format(self.__class__))

    @classmethod
    def _newp(cls, init):
        raise TypeError(
            "expected a pointer or array ctype, got '{}'".format(cls._get_c_name())
        )
    ...
    def _arg_to_ctypes(cls, *value):
        try:
            ...
            raise TypeError("cannot create an instance of {!r}".format(cls))
        if value:
    ...
    @classmethod
    def _fix_class(cls):
        cls.__name__ = "CData<{}>".format(cls._get_c_name())
        cls.__qualname__ = "CData<{}>".format(cls._get_c_name())
        cls.__module__ = "ffi"
    ...
    def __repr__(self, c_name=None):
        ...
        return "<cdata {!r} {}>".format(c_name or self._get_c_name(), own)

    def _convert_to_address(self, BClass):
        if BClass is None:
            raise TypeError(
                "cannot convert {!r} to an address".format(self._get_c_name())
            )
        else:
            raise TypeError(
    ...
    def _cast_from(cls, source):
        raise TypeError("cannot cast to {!r}".format(cls._get_c_name()))
    ...
    def _to_string(self, maxlen):
        raise TypeError("string(): {!r}".format(self))
...
class CTypesGenericPtr(CTypesData):
    ...
    def _cast_from(cls, source):
        if source is None:
            ...
            raise TypeError(
                "bad type for cast to {!r}: {!r}".format(cls, type(source).__name__)
            )
...
class CTypesBaseStructOrUnion(CTypesData):
    ...
    def _create_ctype_obj(cls, init):
        # may be overridden
        raise TypeError("cannot instantiate opaque type {}".format(cls))
...
class CTypesBackend(object):
        ...
        class CTypesVoid(CTypesData):
            ...
            def _to_ctypes(novalue):
                if novalue is not None:
                    raise TypeError(
                        "None expected, got {} object".format(type(novalue).__name__)
                    )
                return None
    ...
    def new_array_type(self, CTypesPtr, length):
        ...
        class CTypesArray(CTypesGenericArray):
                ...
                if isinstance(init, bytes):
                    ...
                    if isinstance(init, CTypesGenericArray):
                        if len(init) != len(blob) or not isinstance(init, CTypesArray):
                            raise TypeError("length/type mismatch: {}".format(init))
                    init = tuple(init)
            ...
            @classmethod
            def _cast_from(cls, source):
                raise NotImplementedError("casting to {!r}".format(cls._get_c_name()))
    ...
    def _new_struct_or_union(self, kind, name, base_ctypes_class):
        ...
        struct_or_union.__name__ = "{}_{}".format(kind, name)
        kind1 = kind
        #
        class CTypesStructOrUnion(CTypesBaseStructOrUnion):
            __slots__ = ["_blob"]
            _ctype = struct_or_union
            _reftypename = "{} &".format(name)
            _kind = kind = kind1
    ...
    def new_function_type(self, BArgs, BResult, has_varargs):
        ...
        class CTypesFunctionPtr(CTypesGenericPtr):
            ...
            _reftypename = BResult._get_c_name("(* &)({})".format(nameargs))
            ...
            def _get_own_repr(self):
                if getattr(self, "_own_callback", None) is not None:
                    return "calling {!r}".format(self._own_callback)
