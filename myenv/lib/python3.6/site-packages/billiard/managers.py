...
class Token(object):
    ...
    def __repr__(self):
        return "{}(typeid={!r}, address={!r}, id={!r})".format(
...
class BaseProxy(object):
    ...
    def __repr__(self):
        return "<{} object, typeid {!r} at {:#x}>".format(
...
class Value(object):
    ...
    def __repr__(self):
        return "{}({!r}, {!r})".format(type(self).__name__, self._typecode, self._value)
...
_ArrayProxy_Attributes = ("__len__", "__getitem__", "__setitem__")
if not PY3:
