...
def _get_gssapi_mechanism():
    try:
        ...
        class FakeGSSAPI(SASL):
            ...
            def __init__(
                self, client_name=None, service=b"amqp", rdns=False, fail_soft=False
            ):
                if not fail_soft:
                    raise NotImplementedError(
        ...
        class GSSAPI(SASL):
            ...
            def get_hostname(self, connection):
                ...
                if self.rdns and sock.family in (socket.AF_INET, socket.AF_INET6):
...
class RAW(SASL):
    ...
    def __init__(self, mechanism, response):
        ...
        warnings.warn(
            "Passing login_method and login_response to Connection "
