...
class _AbstractTransport(object):
            ...
            try:
                ...
                if n + 1 >= addr_types_num:
                    ...
                    raise (
                        e
                        if e is not None
                        else socket.error("failed to resolve broker hostname")
                    )
    ...
    def _init_socket(self, socket_settings, read_timeout, write_timeout):
        ...
        for timeout, interval in (
            (socket.SO_SNDTIMEO, write_timeout),
    ...
    def read_frame(self, unpack=unpack):
        ...
        if ch == 206:  # '\xce'
            ...
            raise UnexpectedFrame("Received {:#04x} while expecting 0xce".format(ch))
...
class SSLTransport(_AbstractTransport):
    ...
    def _read(
        self, n, initial=False, _errnos=(errno.ENOENT, errno.EAGAIN, errno.EINTR)
    ):
